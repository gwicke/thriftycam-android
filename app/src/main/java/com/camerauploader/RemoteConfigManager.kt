...
object RemoteConfigManager {
    ...
    fun toJson(context: Context): String {
        ...
        return JSONObject().apply {
            ...
            put("av1_film_grain_noise",        s.getAv1FilmGrainNoise(context))
    ...
    fun mergeFromJson(context: Context, json: String): Set<String> {
        ...
        return try {
            ...
            if (obj.has("av1_film_grain_noise"))
                sync("av1_film_grain_noise", s.getAv1FilmGrainNoise(context),
                    obj.getInt("av1_film_grain_noise").coerceIn(0, 255)) {
                    s.setAv1FilmGrainNoise(context, it)
                }
